  ...
  <div class="container">
    <div class="map-search-container">
      <div>
        ...
        <van-search v-model="searchInfo" placeholder="地址搜索" @search="search" />
      </div>
      <div id="map-search-container"></div>
    </div>
    <div id="map-container"></div>
    <div class="pd10">
      <div> {{ info.address }}({{ info.lng }},{{ info.lat }})</div>
      <div class="text-center">
        <van-button size="small" type="info" @click="selected"> <i class="iconfont">&#xe690;</i>确定 </van-button>
        <van-button size="small" type="warning" @click="canceled"> <i class="iconfont">&#xe61b;</i>取消 </van-button>
      </div>
    </div>
  </div>
</template>
