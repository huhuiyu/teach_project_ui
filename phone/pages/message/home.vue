<template>
	<view class="container">
		<view class="input-box">
			<input type="text" v-model="messageData.queryInfo.info" class="uni-input" confirm-type="search" placeholder="请输入你想搜索的" @confirm="queryAll" />
		</view>
		<view>
			<view class="tabbar">
				<view class="navigator">
					<view class="navigator-item" v-for="item in toolsData.tabList" :key="item.id" @click="changeOrderBy(item.id)">
...
import BaseResult, { BaseListResult } from '../../script/entity/BaseResult';
import { MessageDetail } from '../../script/entity/MessageDetailResult';
